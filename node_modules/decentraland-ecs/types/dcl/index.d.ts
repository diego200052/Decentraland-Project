 ...
 * @public
 */
declare class OnPointerDown extends OnUUIDEvent<'pointerDown'> {
  readonly type: string
 ...
 * @public
 */
declare class OnPointerUp extends OnUUIDEvent<'pointerUp'> {
  readonly type: string
...
declare class RaycastResponse<T> {
  ...
  constructor(payload: { queryId: string; queryType: string; payload: T })
}
