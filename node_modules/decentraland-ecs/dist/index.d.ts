 ...
 * @public
 */
export declare interface BasicAvatarInfo {
    userId: string;
    name: string;
}
...
export declare class Eyes {
    ...
    color?: ReadOnlyColor4 | undefined;
...
/* Excluded from this release type: Frustum */
...
/* Excluded from this release type: Gizmo */
...
/* Excluded from this release type: Gizmos */
 ...
 * @public
 */
export declare interface HitEntityInfo {
    isValid: boolean;
    entityId: string;
    meshName: string;
}
...
/* Excluded from this release type: newId */
...
/* Excluded from this release type: OnGizmoEvent */
 ...
 * @public
 */
export declare interface RaycastHitAvatar extends RaycastHit {
 ...
 * @public
 */
export declare interface RaycastHitAvatars extends RaycastHit {
 ...
 * @public
 */
export declare interface RaycastHitEntities extends RaycastHit {
 ...
 * @public
 */
export declare interface RaycastHitEntity extends RaycastHit {
